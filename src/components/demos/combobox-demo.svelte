...
<div class="flex flex-col gap-1">
	...
	<label use:melt={$label}>
		<span class="text-sm font-medium text-foreground">Choose your favorite manga:</span>
	</label>
	...
	<div class="relative">
		...
		/>
		<div class="absolute right-2 top-1/2 z-10 -translate-y-1/2 text-foreground">
			{#if $open}
...
{#if $open}
	...
	>
		...
		>
		  ...
		  data-[highlighted]:bg-magnum-200 data-[highlighted]:text-foreground
			data-[disabled]:opacity-50"
				>
					{#if $isSelected(book)}
						<div class="check absolute left-2 top-1/2 z-10 text-foreground">
...
<style lang="postcss">
	.check {
		@apply absolute left-2 top-1/2 text-foreground;
